    ...
    <div id="experience" className="py-10 sm:py-16 relative">
      <div className="section-container">
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-16 relative items-start">
          ...
          {/* Sticky Left Column */}
          <div className="lg:col-span-4 lg:sticky lg:top-32 mb-20 lg:mb-0 relative z-10">
                    ...
                    <div className="glass-card rounded-3xl p-8 sm:p-10 transition-all hover:-translate-y-1">
                      ...
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-8">
                        <div>
                          ...
                          <h3 className="font-heading font-bold text-2xl sm:text-3xl text-white-custom mb-1">
                        ...
                        <div className="mt-4 sm:mt-0 font-mono text-xs text-muted-2 uppercase tracking-wide">
                          {exp.location}
                        </div>
                      </div>
                      ...
                      <ul className="space-y-4">
                        {exp.bullets.map((bullet, j) => (
                          <li key={j} className="flex gap-4 items-start text-sm sm:text-base text-muted-custom font-light leading-relaxed">
                            <span className="text-accent mt-1 opacity-50 text-xs shrink-0">▹</span>
